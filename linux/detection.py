...
while True:
    ...
    if person_box:
        ...
        # SMART: Increase authority near center where we need precision
        if error_mag < 40:
            # Close to center - give it more power to finish the job
            current_max_step_pan *= 1.3
            current_max_step_tilt *= 1.3
